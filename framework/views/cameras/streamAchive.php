...
<body>
	<div class="container">
		...
		<div class="row" id="archive_camera_holder">
			<div class="col s12 m12 l12">
				<img src="http://localhost:4000/public/streamArchive/5/1494343224.png" id="archive_camera_stream">
			</div>
		</div>
	...
	<script type="text/javascript"> getCameraId("<?php echo $camera["id"]; ?>"); </script>
</body>
</html>
